...
| :--- | :--- | :--- |
| **2312647** | Lê Anh Khoa | **FR-RCP-001:** Danh sách công thức (phân trang, lọc, sắp xếp)<br>**FR-RCP-002:** Xem chi tiết công thức<br>**FR-RCP-003:** Tạo công thức<br>**FR-RCP-004:** Cập nhật công thức<br>**FR-RCP-005:** Đăng / Hủy đăng công thức<br>**FR-RCP-006:** Lưu trữ công thức<br>**FR-RCP-007:** Xóa công thức<br>**FR-RCP-009:** Quản lý nguyên liệu của công thức<br>**FR-RCP-010:** Quản lý các bước thực hiện công thức<br>**FR-JOB-002:** Xử lý ảnh và tạo ảnh thumbnail |
...
| **2312639** | Vũ Thế Huỳnh | **FR-RCP-008:** Quản lý hình ảnh công thức (Upload / Đặt ảnh chính / Xóa)<br>**FR-SRCH-001:** Tìm kiếm toàn văn<br>**FR-SRCH-002:** Lọc công thức<br>**FR-SRCH-003:** Sắp xếp công thức<br>**FR-SRCH-004:** Phân trang kết quả<br>**FR-FILE-001:** Upload file lên MinIO<br>**FR-FILE-002:** Xóa file khỏi MinIO |
